...
fun AddHomeworkDialog(
    ...
    val subjects = listOf(
        "Алгебра", "Геометрия", "Русский язык", "Литература", "Обществознание",
        "История", "Физика", "Английский", "ИП", "Химия", "ДРЯ",
        "ЦСЯ/Литургика", "Биология", "История Церкви",
        "ОБЖ", "География", "Физкультура", "Информатика", "ОПВ",
    )
